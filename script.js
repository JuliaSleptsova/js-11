...
// Flats 111111111111111111111
// function getFlatLocation(totalFlats, flatsPerFloor, flatNumber) {
//   const flatsPerEntrance = flatsPerFloor * Math.ceil(totalFlats / flatsPerFloor / 2);
//   const entrance = Math.ceil(flatNumber / flatsPerEntrance);
//   const relativeFloor = Math.ceil(flatNumber / flatsPerFloor) - (entrance - 1) * Math.ceil(totalFlats / flatsPerFloor / 2);
//   const floor = Math.max(relativeFloor, 1);
//   return { entrance, floor };
// }
// const flatLocation = getFlatLocation(100, 10, 63);
// console.log(flatLocation);

// Credentials 111111111111111
